  ...
  return (
    <SectionLayout idName="skills" classNames="bg-white">
      ...
      >
        ...
        <div
          className={
            "grid grid-cols-3 gap-6 place-items-center lg:grid-cols-5 lg:gap-x-8 xl:gap-x-12"
          }
        >
          {skills &&
            skills.map((skill) => (
              <motion.div
                ...
                key={skill._id}
                className={
                  "flex flex-col items-center space-y-2 col-auto transition-all duration-400 ease-in-out hover:drop-shadow-xl"
                }
              >
                <div className="rounded-full p-4 shine bg-primary w-24 h-24 flex items-center justify-center">
